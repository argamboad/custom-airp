...
| **dials** | Per-conversation Creativity (→ temperature 0.6–1.4), ResponseLength (→ ceiling 200–2600, and into the prompt) and Lust (into the prompt only). The reader's wording and the model's are the same text. |
